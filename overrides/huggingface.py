...
class HFTransformer(BaseLLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if (
            self.gen_params["stop_words"] is not None
            and self.gen_params["stop_words_id"] is not None
        ):
            logger.warning(
                "Both stop_words and stop_words_id are specified,"
        ...
        **kwargs,
        ...
        with torch.no_grad():
            ...
            while True:
                ...
                model_kwargs = (
                    self.model._update_model_kwargs_for_generation(  # noqa: E501
